...
Cross-repo and workspace items live in `D:\Codes\progress.md` (relevant here: X-7, X-14, L-7, W-4).
...
- **#4** `.idea/workspace.xml` is tracked and contains local absolute paths (workspace W-4).
